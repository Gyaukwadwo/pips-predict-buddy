...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "AI-powered technical analysis and entry signals for major FX pairs, metals, and crypto." },
      { name: "author", content: "Pipwise" },
      { property: "og:title", content: "Pipwise — AI Forex Analyst" },
      { property: "og:description", content: "AI-powered technical analysis and entry signals for major FX pairs, metals, and crypto." },
